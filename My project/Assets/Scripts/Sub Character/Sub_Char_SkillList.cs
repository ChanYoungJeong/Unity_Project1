...
public class Sub_Char_SkillList : MonoBehaviour
{
    ...
    public void create()
    {
        ...
        name = "Kunai"; //도적 스킬
        Sub_Char_SkilList.Add(name, new Sub_Char_Skill(0, name, 20, 0, 0, 20, 1)); //Sub1 Attacker //도적스킬

        name = "Lightning";
        Sub_Char_SkilList.Add(name, new Sub_Char_Skill(1, name, 10, 0, 0, 26, 1)); //Sub1 Attacker //매직캐스터 스킬
        ...
        name = "MegaArrow";
        Sub_Char_SkilList.Add(name, new Sub_Char_Skill(3, name, 20, 0, 0, 23, 1));
        ...
        Sub_Char_SkilList.Add(name, new Sub_Char_Skill(5, name, 8, 0, 0, 25, 1));
